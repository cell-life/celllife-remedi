...
/**
 * Data Transfer Object (DTO) used to contain Msisdn/User specific USSD request
 * data
 */
public class MsisdnVisitsDTO {
	...
	public MsisdnVisitsDTO(String ussdSessionId, Date start, Date end,
			String msisdn, MobileNetwork mno) {
	...
	public MsisdnVisitsDTO(String ussdSessionId, Date start, Date end,
		...
		if (this.mobileNetwork == null) {
			log.warn("Ignoring invalid mno_code (Mobile Network Operator) '"
					+ mno_code + "' for ussdSessionId=" + ussdSessionId);
		}
	}

	public MsisdnVisitsDTO(String ussdSessionId, Date start, Date end,
			String msisdn, String mno_code) {
		this.ussdSessionId = ussdSessionId;
		this.start = start;
		this.end = end;
		this.msisdn = msisdn;
		if (mno_code != null) {
			try {
				this.mobileNetwork = MobileNetwork.convert(Integer
						.parseInt(mno_code));
	...
	public enum MobileNetwork {
		MTN("MTN"), VODACOM("Vodacom"), CELLC("Cell C/Virgin/Red Bull Mobile"), TELKOM(
				"Telkom Mobile");
	...
	public String getDate() {
		return new SimpleDateFormat("dd MMM yyyy").format(start);
	}
	...
	public String getNetwork() {
		return (getMobileNetwork() == null ? "" : getMobileNetwork().getDescription());
	}
	...
	public String toString() {
		return "MsisdnVisitsDTO [ussdSessionId=" + ussdSessionId + ", start="
				+ start + ", end=" + end + ", msisdn=" + msisdn
